...
import { Briefcase, ChevronRight, Users, Trash2, Pin, Sparkles, Pencil, Share2, Check, X, Loader2 } from 'lucide-react';
...
export const JobCard: React.FC<JobCardProps> = ({ job, onClick, onDelete, onPin, onEdit, onShare, isDeleting = false }) => {
  ...
  return (
    ...
    >
        ...
        {/* HEADER DO CARD: Layout Justificado (Icone esquerda, Ações direita) */}
        ...
        {/* FOOTER DO CARD: Layout Justificado */}
