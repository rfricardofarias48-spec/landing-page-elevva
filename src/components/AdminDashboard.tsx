                                  ...
                                  <div className="grid grid-cols-2 gap-4">
                                      ...
                                      <div className="col-span-2 bg-zinc-50 rounded-xl px-4 py-3 text-sm">
                                          {directLinkForm.plan === 'ENTERPRISE' ? (
                                              ...
                                              const ANUAL: Record<string,string> = { ESSENCIAL: 'R$ 3.839,04/ano', PRO: 'R$ 6.230,40/ano', MAX: 'R$ 12.591,60/ano', ULTRA: 'R$ 19.311,60/ano' };
                                        ...
                                        <div className="pt-2 border-t border-slate-200">
                                            ...
                                            <div className="mt-4 pt-4 border-t border-slate-200">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <input
                                                        type="tel"
                                                        placeholder="Ex: 51993806261 ou 5551993806261"
